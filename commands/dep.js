...
module.exports.run = async (client, message, args) => {
    ...
    .setColor("BLACK")
    .setDescription(`<a:Sirene:810572998037733397> **|** Coloque o valor do deposito!`);
    ...
    .setColor("BLACK")
    .setDescription(`<a:Sirene:810572998037733397> **|** Você não Money suficiente para realizar o deposito!`);
    ...
    .setColor("BLACK")
    .setDescription(`<a:Sirene:810572998037733397> **|** Você tem que colocar um valor maior que **0** para realizar o deposito!`);
    ...
    .setColor("BLACK")
    .setDescription(`<a:Sirene:810572998037733397> **|** Você tem que colocar um valor numerico para realizar o deposito!`);
